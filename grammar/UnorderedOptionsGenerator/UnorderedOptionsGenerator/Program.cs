namespace UnorderedOptionsGenerator
{

    // The objective is to convert this:
    // dot dob dof
    //
    // into this:
    //
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var list = new List<string> { "dot", "dob", "dof"};

            var perms = list.ToArray().Permute();
        }


    }

    public static class PermutationExtensions // From: https://stackoverflow.com/a/43033661
    {
        /// <summary>
