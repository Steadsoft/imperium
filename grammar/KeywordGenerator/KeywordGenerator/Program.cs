...
namespace KeywordGenerator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            file.WriteLine($"/* These Antlr4 keyword token defintions were generated by a utility on {DateTime.Now.ToShortDateString()} at {DateTime.Now.ToShortTimeString()} */");
            file.WriteLine();
            ...
            file.WriteLine() ;
            file.WriteLine("/* End of generated Antlr4 keyword token defintions. */");
