...
namespace KeywordGenerator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            file.WriteLine($"/* These tokens defintions were generated by a utility on {DateTime.Now.ToShortDateString()} at {DateTime.Now.ToShortTimeString()} */");
            file.WriteLine();
            ...
            file.WriteLine() ;
            file.WriteLine("/* end of generated tokens defintions. */");
