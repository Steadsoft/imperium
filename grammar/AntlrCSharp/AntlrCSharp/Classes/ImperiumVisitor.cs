...
namespace AntlrCSharp
{
    ...
    public class ImperiumVisitor : ImperiumBaseVisitor<AstNode>
    {
        ...
        public override AstNode VisitDeclaration([NotNull] DeclarationContext context)
        {
            ...
            return stmt switch
            {
                DeclareNameContext => VisitDeclareName((DeclareNameContext)(context.children[0])),
                DeclareAsContext => VisitDeclareAs((DeclareAsContext)(context.children[0])),
                _ => null
            };
        ...
        public override AstNode VisitDeclareName([NotNull] DeclareNameContext context)
        {
            ...
            var dataAttribute = context.declarationBody().typeInfo().attributes().dataAttribute();
            var memoryAttribute = context.declarationBody().typeInfo().attributes().memoryAttribute();
            var linkageOption = context.declarationBody().typeInfo().attributes().linkageOption();
            var dimensionSuffix = context.declarationBody().typeInfo().dimensionSuffix();
