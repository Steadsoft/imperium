...
public class ImperiumParser extends Parser {
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & -1152903912424945666L) != 0 || (((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 2160074753L) != 0 );
			setState(259);
			match(RPAR);
			}
		}
	...
	public final KeywordContext keyword() throws RecognitionException {
		...
		try {
			...
			setState(415);
			_la = _input.LA(1);
			if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 17592181901310L) != 0) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Type_infoContext type_info() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 549488424960L) != 0) {
				{
				{
				setState(444);
				attribute();
