...
/* These Antlr4 keyword token definitions were generated by a utility on 1/8/2023 at 2:26 PM */
...
COROUTINE: {KeywordLanguageCode == "de"}? ('coroutine') | {KeywordLanguageCode == "en"}? ('coroutine') | {KeywordLanguageCode == "fr"}? ('coroutine') | {KeywordLanguageCode == "he"}? ('coroutine') | {KeywordLanguageCode == "nl"}? ('co routine') ;
...
READONLY: {KeywordLanguageCode == "de"}? ('readonly') | {KeywordLanguageCode == "en"}? ('readonly') | {KeywordLanguageCode == "fr"}? ('readonly') | {KeywordLanguageCode == "he"}? ('readonly') | {KeywordLanguageCode == "nl"}? ('alleen lezen') ;
...
RETURNON: {KeywordLanguageCode == "de"}? ('retour_si') | {KeywordLanguageCode == "en"}? ('returnon') | {KeywordLanguageCode == "fr"}? ('retour_si') | {KeywordLanguageCode == "he"}? ('returnon') | {KeywordLanguageCode == "nl"}? ('terug bij') ;
