...
string_literal: BASIC_STRING_LITERAL | ESCAPED_STRING_LITERAL;

BASIC_STRING_LITERAL: DoubleQuote (AllButDquote | PairedQuote)* DoubleQuote;
ESCAPED_STRING_LITERAL: 	DoubleQuote  (~["\\\r\n\u0085\u2028\u2029] | CommonCharacter)* EscapedQuote;

// enhanced_string_literal: (DQUOTE ( . | NEWLINE)*? DQUOTE ':' 'Q') ;
...
BYTE_ORDER_MARK: '\u00EF' '\u00BB' '\u00BF';
fragment AllButDquote: ~'"';
fragment DoubleQuote: '"';
fragment SingleQuote: '\'';
fragment PairedQuote: '""';
fragment EscapedQuote: '":e';
...
/* ---------------------------------------------------------------------------------------------------- */
/* These Antlr4 keyword token definitions were generated by a utility on 1/13/2023 at 9:04 AM           */
...
/* Expected number of entries per language 66.                                                          */
/* ---------------------------------------------------------------------------------------------------- */
