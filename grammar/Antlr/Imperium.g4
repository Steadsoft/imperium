...
/* These Antlr4 keyword token definitions were generated by a utility on 1/9/2023 at 1:21 PM */
...
CALL: {KeywordLanguageCode == "de"}? ('aufrufen') | {KeywordLanguageCode == "en"}? ('call') | {KeywordLanguageCode == "fr"}? ('appeler') | {KeywordLanguageCode == "he"}? ('call') | {KeywordLanguageCode == "nl"}? ('aanroepen') | {KeywordLanguageCode == "ru"}? ('вызвать') ;
...
RETURN: {KeywordLanguageCode == "de"}? ('rückkehr') | {KeywordLanguageCode == "en"}? ('return') | {KeywordLanguageCode == "fr"}? ('retour') | {KeywordLanguageCode == "he"}? ('return') | {KeywordLanguageCode == "nl"}? ('terug') | {KeywordLanguageCode == "ru"}? ('возврат') ;
...
THEN: {KeywordLanguageCode == "de"}? ('dann') | {KeywordLanguageCode == "en"}? ('then') | {KeywordLanguageCode == "fr"}? ('ensuite') | {KeywordLanguageCode == "ru"}? ('то') ;
