...
/* These Antlr4 keyword token definitions were generated by a utility on 1/7/2023 at 2:15 PM */

ALIGNED: {KeywordLanguageCode == "en"}? ('aligned') | {KeywordLanguageCode == "fr"}? ('aligned') | {KeywordLanguageCode == "he"}? ('aligned') ;
...
AUTOMATIC: {KeywordLanguageCode == "en"}? ('automatic' | 'auto') | {KeywordLanguageCode == "fr"}? ('automatic') ;
...
GO: {KeywordLanguageCode == "en"}? ('go') | {KeywordLanguageCode == "fr"}? ('go') ;
GOTO: {KeywordLanguageCode == "en"}? ('goto') | {KeywordLanguageCode == "fr"}? ('goto') | {KeywordLanguageCode == "he"}? ('goto') | {KeywordLanguageCode == "nl"}? ('ga') ;
...
INCLUDE: {KeywordLanguageCode == "en"}? ('include' | 'inc') | {KeywordLanguageCode == "fr"}? ('include' | 'inc') ;
