...
/* These Antlr4 keyword token definitions were generated by a utility on 1/8/2023 at 9:42 AM */
...
GOTO: {KeywordLanguageCode == "en"}? ('goto' | 'go to') | {KeywordLanguageCode == "fr"}? ('aller à') | {KeywordLanguageCode == "he"}? ('goto') | {KeywordLanguageCode == "nl"}? ('ga') ;
