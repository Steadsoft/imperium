...
preprocessor_stmt: PCNT 'include' QUOTE identifier '.inc' QUOTE SEMICOLON |
...
string_literal: basic_string_literal;

basic_string_literal: (DQUOTE ( . | NEWLINE)*? DQUOTE) ;
...
/* ---------------------------------------------------------------------------------------------------- */
/* These Antlr4 keyword token definitions were generated by a utility on 1/11/2023 at 8:40 AM           */
...
/* Expected number of entries per language 64.                                                          */
/* ---------------------------------------------------------------------------------------------------- */
