...
/* These Antlr4 keyword token definitions were generated by a utility on 1/9/2023 at 1:58 PM */
...
GOTO: {KeywordLanguageCode == "de"}? ('gehen') | {KeywordLanguageCode == "en"}? ('goto' | 'go to') | {KeywordLanguageCode == "fr"}? ('aller à') | {KeywordLanguageCode == "he"}? ('goto') | {KeywordLanguageCode == "nl"}? ('ga') | {KeywordLanguageCode == "ru"}? ('перейти к') ;
